...
export const StaticConstruction = ({ size = 28, color = "currentColor", ...props }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
    ...
    >
        ...
        <path d="M17 3v3" />
        <path d="M7 3v3" />
        <path d="M3 8l3 4M8 8l3 4M13 8l3 4M18 8l2 2.6" strokeWidth="1.5" />
    </svg>
);

export const StaticAtom = ({ size = 28, color = "currentColor", ...props }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const StaticFileText = ({ size = 28, color = "currentColor", ...props }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const StaticIdCard = ({ size = 24, color = "currentColor", ...props }: IconProps) => {
    return (
        <svg
...
export const StaticDatabaseBackup = ({ size = 20, color = "currentColor", ...props }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
